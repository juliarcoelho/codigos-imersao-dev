...
var cartaMaquina
var cartaJogador
var cartas = [cartaJulia, cartaFlavia, cartaPaulo, cartaRafa, cartaGui, cartaLol, cartaNaruto, cartaHarry, cartaBatman, cartaMarvel]
...
function jogar() {
  ...
  if (cartas.length == 0) {
    ...
    if (pontosJogador > pontosMaquina){
      htmlResuldado + "<p class='resultado-final'>VENCEU</p>"
    } else if (pontosMaquina > pontosJogador) {
      htmlResuldado + "<p class='resultado-final'>PERDEU</p>"
    } else {
      htmlResuldado + "<p class='resultado-final'>EMPATOU</p>"
    }
  } else {
...
function proximaRodada() {
  ...
  divCartas.innerHTML = `<div id="cartas-jogador" class="cartas"></div> <div id="carta-maquina" class="carta"></div>`
